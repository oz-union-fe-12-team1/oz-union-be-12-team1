...
class UserLocation(Model):
    ...
    user = fields.ForeignKeyField("models.User", related_name="user_locations", on_delete=fields.CASCADE)
    ...
    def __str__(self):
        return f"UserLocation(id={self.id}, user_id={self.user_id}, location={self.location_name})"
